...
class _RestaurantDetailScreenState extends State<RestaurantDetailScreen> {
  ...
  Widget _buildRestaurantDetails(Restaurant restaurant) {
    ...
    final userId = Supabase.instance.client.auth.currentUser?.id != null ? int.parse(Supabase.instance.client.auth.currentUser!.id) : null;

    return SingleChildScrollView( // Enveloppe le Column avec SingleChildScrollView
      child: Padding(
